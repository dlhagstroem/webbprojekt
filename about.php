...
include("inc/header.php"); ?>
	...
	<div id="mainstyle" class="container">
		<div class="row">
			<div class="col-lg-12">
				<h1>Läsa om oss, våga säga nej till mobbning!</h1>
			</div>
		</div> <!-- row end -->
		<div class="row">
		<div class="col-md-8">
			...
			diskriminering och mobbning bland unga. Vår idé är att den som hjälper någon av de insamlande organisationerna med ett bidrag 
			ska få något tillbaka. Därför erbjuder vi stödpaket som innebär att du ger en gåva till verksamheten och som tack för hjälpen 
			får du ett gåvobevis och antingen ett halsband, armband eller gosedjur skickat på posten. På så vis kan vi tillsammans visa 
			att vi inte tolererar att något barn ska behöva utsättas för någon som helst form av mobbning. 
			<br>
			<br>
